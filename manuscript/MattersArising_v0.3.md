...
All source data are public and listed in the *Methods* section. Code reproducing every figure panel and statistical claim in this manuscript is available at https://github.com/peijianying/pce-circularity and archived on Zenodo (https://doi.org/10.5281/zenodo.20621025). Intermediate results (CSV tables, RDS objects) and the rendered Figure 1 (PDF + PNG) are bundled with the repository.
...
- Once GitHub repo is public and Zenodo DOI is minted, replace `[your-username]` and `[TBD]` placeholders. **DONE 2026-06-10:** GitHub repo at https://github.com/peijianying/pce-circularity; Zenodo DOI 10.5281/zenodo.20621025.
